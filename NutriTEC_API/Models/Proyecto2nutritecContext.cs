...
public partial class Proyecto2nutritecContext : DbContext
{
    ...
    public virtual DbSet<ProductDishState> ProductDishStates { get; set; }
    
    public virtual DbSet<AllProductDish> AllProductDishes { get; set; }

    public virtual DbSet<InsertAdmin> InsertAdmins { get; set; }
    
    public virtual DbSet<InsertClient> InsertClient { get; set; }

    public virtual DbSet<UpdateClientMeasurements> UpdateClient { get; set; }
    ...
    public virtual DbSet<DeleteRecipeFunction> DeleteRecipeFunctions { get; set; }

    public virtual DbSet<GetClientEatingPlan> GetClientEatingPlans { get; set; }

    public virtual DbSet<GetEatingPlan> GetEatingPlans { get; set; }

    public virtual DbSet<GetProductsByRecipe> GetProductsByRecipes { get; set; }

    public virtual DbSet<ProductDishFunction> ProductDishFunctions { get; set; }

    public virtual DbSet<InsertRecipeFunction> InsertRecipeFunctions { get; set; }

    public virtual DbSet<SearchClient> SearchClients { get; set; }

    public virtual DbSet<ProductIdentifier> ProductIdentifiers { get; set; }

    public virtual DbSet<UpdateClientMeasurements> UpdateClientMeasurements { get; set; }

    public virtual DbSet<UpdateProductFunction> UpdateProductFunctions { get; set; }
    ...
    public virtual DbSet<NutritionistIdentifier> NutritionistIdentifiers { get; set; }

    public virtual DbSet<EmployeeIdentifier> EmployeeIdentifiers { get; set; }

    public virtual DbSet<GetClientByNutritionist> GetClientByNutritionists { get; set; }
    
    public virtual DbSet<GetEatplanByNutritionist> GetEatplanByNutritionists { get; set; }

    public virtual DbSet<NutriSearchProduct> NutriSearchProducts { get; set; }

    public virtual DbSet<GetNutritionistPlan> GetNutritionistPlans { get; set; }
